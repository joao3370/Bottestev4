...
const { destrava } = require('./src/destrava')         /* ESTA VERSÃO DESSE SOFTWARE É PAGA, NÃO DIVULGUE DE FORMA GRATUITA. */
...
async function starts() {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				try {
					...
					ppimg = 'https://tenor.com/view/bem-vindo-cute-smile-anime-girl-gif-14836470'
				}
				teks = `Olá @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}*\n\nEspero que goste, leia as regras❤️`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					benned: 'banido🤪👍',
					ownerG: '[❗] Este é um recurso especial para o meu dono ❌',
					ownerB: '[❗] Este é um recurso especial para o meu dono ❌',
			...
			const ownerNumber = ["554891635455@s.whatsapp.net","17404627820@s.whatsapp.net"] // número de dono 
			const mod = [ownerNumber,"554891635455@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de mod/dono 
			const adminbotnumber = ["554891635455@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de adm
			const frendsowner = ["554891635455@s.whatsapp.net","17404627820@s.whatsapp.net"]//número de "amigos" (arrumar definição) 
		...
		if (isGroupAdmins) return reply('cara, nao fale essas coisas, isso � errado')
	...
	if (messagesC.includes("vidaloka2")){
            ...
            delVote(from)
            reply('Eliminado com sucesso a sess�o de vota��o neste grupo')
            break
    case 'voting':
